...
////////////////////////////////////////////////////////////////////////////////////////////////////////
      Console.WriteLine(world.KPIs.ToString());
////////////////////////////////////////////////////////////////////////////////////////////////////////

            return !aborted;
    }

        protected override bool RunSimulation2(byte[] settingsBuf, INetMQSocket requestSocket, string id, bool simulateAsync = true, bool useIntegratedPolicy = false)
        {
            var settings = Serializer.Deserialize<Settings>(settingsBuf.AsSpan());
            if (useIntegratedPolicy)
                sim = new HotstorageSimulation(settings, new RuleBasedCranePolicy());
            else
                sim = new HotstorageSimulation(settings, new SynchronousSimRunnerPolicy(requestSocket, id));
